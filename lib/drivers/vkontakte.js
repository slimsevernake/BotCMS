...
class VKontakte {
    ...
    async reply (ctx, Parcel) {
        ...
        return ctx.send(sending)/*.then((message) => console.log(message))*/;
    }
    ...
    async send (Parcel) {
        ...
        return this.Transport.api.messages.send(sending)/*.then(message => this.defaultCallback(this, {update: {message: message}}, true))*/;
    }
