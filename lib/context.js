...
class Context {
    ...
    async process () {
        ...
        if (this.Message.query.id !== '') {
            ...
            let stored = this.getCallbackData(this.Message.query.data)
            ...
            if (!!this.Message.query.answer) {
                if (typeof this.Message.query.answer === 'string') {
                    this.Message.query.answer = await this.lexicon(this.Message.query.answer, this.Message.query.params || {})
                }
                this.answerCallback(this.Message.query)
            }
        }
     ...
     */
    answerCallback (data) {
        this.Bridge.answerCallback(data)
    }
